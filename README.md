...
### 理由:
現在開発しているアルバイトシフト管理アプリの開発において、バックエンドの知識が乏しいと感じた。
この理由として、簡単なフルスタック開発の練習をせずに取り組んでしまったことが原因であると考察しました。
...
### 今後の展望
まだまだ経験が不足していることを痛感しているため、
次はgolangのginフレームワーク, PostgreSQLを使用したバージョンで開発をする予定
